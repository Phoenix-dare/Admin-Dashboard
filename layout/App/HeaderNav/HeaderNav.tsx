...
const HeaderNav = ({ handleOpen, opened }: HeaderNavProps) => {
      ...
      <Group spacing={2}>
        ...
        {!mobile_match && (
          <TextInput
            ...
            sx={{ width: tablet_match ? "auto" : rem(400) }}
          />
        )}
      </Group>
      <Group>
        ...
        <Menu shadow="lg" width={320}>
          <Menu.Target>
            <Indicator processing size={10} offset={6}>
              <Tooltip label={t("messages")}>
                <ActionIcon size="lg" title={t("messages")}>
          ...
          <Menu.Dropdown>
            <Menu.Label tt="uppercase" ta="center" fw={600}>
              {MESSAGES.length} {t("new")}  {t("notifications")}
            </Menu.Label>
            {messages}
            <Menu.Item tt="uppercase" ta="center" fw={600}>
            {t("show_all")} {t("messages")}
            </Menu.Item>
          </Menu.Dropdown>
        </Menu>
        <Menu shadow="lg" width={320}>
          ...
          <Menu.Dropdown>
            <Menu.Label tt="uppercase" ta="center" fw={600}>
              {NOTIFICATIONS.length} {t("new")} {t("notifications")}
            </Menu.Label>
            {notifications}
            <Menu.Item tt="uppercase" ta="center" fw={600}>
              {t("show_all")} {t("notifications")}
            </Menu.Item>
          </Menu.Dropdown>
        </Menu>
        <Tooltip label={t("log_out")}>
          <ActionIcon>
